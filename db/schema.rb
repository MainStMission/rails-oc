...
ActiveRecord::Schema.define(version: 20130712203415) do
  ...
  add_index "neighbors", ["household_id"], name: "index_neighbors_on_household_id", using: :btree
  add_index "neighbors", ["last_name"], name: "index_neighbors_on_last_name", using: :btree
