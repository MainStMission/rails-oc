...
describe VolunteersController, :type => :controller do
  ...
  describe 'GET sign_in' do
    it 'signs in the volunteer' do
      pending('waiting new timer')
      get :sign_in, {id: volunteer.to_param}
     pending( expect(response).to redirect_to(time_clock_path))
    end
  end
  ...
  describe 'POST create' do
    describe 'with valid params' do
      it 'creates a new Volunteer' do
        expect {
          post :create, {volunteer: {first_name: 'bob', last_name: 'yost'}}
    ...
    describe 'with invalid params' do
      it "re-renders the 'new' template" do
        post :create, {volunteer: {first_name: ''}}
